...
void TestQueen::getMoves_slideToEnd()
{
   ...
   Move c2a2, c2b2, c2d2, c2e2, c2f2, c2g2,
   c2h2, c2c1, c2c3, c2c4, c2c5, c2c6, c2c7, c2c8;
   c2a2.capture = c2b2.capture = c2d2.capture = c2e2.capture = c2f2.capture =
   c2g2.capture = c2h2.capture = c2c1.capture = c2c3.capture = c2c4.capture =
   c2c5.capture = c2c6.capture = c2c7.capture = c2c8.capture = PieceType::SPACE;
   c2a2.source.colRow = c2b2.source.colRow = c2d2.source.colRow = c2e2.source.colRow = c2f2.source.colRow =
   c2g2.source.colRow = c2h2.source.colRow = c2c1.source.colRow = c2c3.source.colRow = c2c4.source.colRow =
   c2c5.source.colRow = c2c6.source.colRow = c2c7.source.colRow = c2c8.source.colRow = 0x21;
...
void TestQueen::getMoves_slideToBlock()
{
   ...
   c2f5.dest.colRow = 0x54;
   c2g6.dest.colRow = 0x65;
   Move c2b2, c2d2, c2e2, c2f2, c2g2,
   c2c3, c2c4, c2c5, c2c6, c2c7;
   c2b2.capture = c2d2.capture = c2e2.capture = c2f2.capture =
   c2g2.capture = c2c3.capture = c2c4.capture =
   c2c5.capture = c2c6.capture = c2c7.capture = PieceType::SPACE;
   c2b2.source.colRow = c2d2.source.colRow = c2e2.source.colRow = c2f2.source.colRow =
   c2g2.source.colRow = c2c3.source.colRow = c2c4.source.colRow =
...
void TestQueen::getMoves_slideToCapture()
{
   ...
   c2g2.capture = c2h2.capture = c2c1.capture = c2c3.capture = c2c4.capture =
   c2c5.capture = c2c6.capture = c2c7.capture = c2c8.capture = PieceType::SPACE;
   c2c1.capture = c2c8.capture = c2a2.capture = c2h2.capture = PieceType::PAWN;
   c2a2.source.colRow = c2b2.source.colRow = c2d2.source.colRow = c2e2.source.colRow = c2f2.source.colRow =
   c2g2.source.colRow = c2h2.source.colRow = c2c1.source.colRow = c2c3.source.colRow = c2c4.source.colRow =
   c2c5.source.colRow = c2c6.source.colRow = c2c7.source.colRow = c2c8.source.colRow = 0x21;
   c2a2.dest.colRow = 0x01;
