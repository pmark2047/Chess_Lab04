...
void TestMove::constructString_simple()
{
   ...
   //verify
   assertUnit(move.source == (4, 4));
   assertUnit(move.dest == (4, 5));
...
void TestMove::assign_simple()
{
   ...
   assertUnit(move.source == (5, 5));
   assertUnit(move.dest == (5, 6));
   assertUnit(move.moveType == Move::MOVE);
}
